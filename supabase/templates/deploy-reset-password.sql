...
<head>
  ...
  <title>Reset your password - Vault</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        We received a request to reset the password for your Vault account. Click the button below to create a new password.
      </p>
  ...
  use_default = false
WHERE template_name = 'reset_password';
