...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        You requested a magic link to sign in to your Vault account. Click the button below to securely access your passwords.
      </p>
      <div class="button-container">
        <a href="{{ .ConfirmationURL }}" class="button">Sign In to Vault</a>
      </div>
